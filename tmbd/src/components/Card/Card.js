    ...
    return (
      <div className={this.props.cardClassName}>
        <h3>{this.props.dataPelis.title}</h3>
          ...
          <img
            src={this.state.link + this.props.dataPelis.poster_path}
            alt={this.props.dataPelis.title}
          />
        ...
        <button className="remove" onClick={() => this.props.borrarPeliculas(this.props.dataPelis.id)}>Borrar</button>
      </div>
    );
  }
}
